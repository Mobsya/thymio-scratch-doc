...
of a program; experiment with different values in the small
square until you have the size the need.}
...
second scripts uses the block \scrblk[-8]{broadcast-and-wait} which causes
